			  	...
			  	<div class="mockup-window border bg-base-300">
			  	  <div class="flex justify-center px-20 py-10 bg-base-200">
			  	  	  	<ul class="list-outside list-disc ">
			  	  	  	      <li class="text-justify" >Diseño e implementación <a href="http://fidelizaleads.cl" class="hover:text-sky-800" target="_blank">Fidelizaleads</a> V1, diseño V2.
			  	  	  	        Plataforma para clasificar leads de ventas inmobiliarias.
			  	  	  	      </li>
			  	  	  	      <li class="text-justify">Diseño implementación y mejoras <a href="https://www.monocontact.com" class="hover:text-sky-800" target="_blank">MonoContact</a>. 
			  	  	  	        Plataforma de email marketing, gestión de contactos y formularios en la nube.
			  	  	  	      </li>
			  	  	  	      <li class="text-justify">Implementación CRM  - <a href="https://www.monocontact.com" class="hover:text-sky-800" target="_blank">MonoContact</a>, Municipalidad de Lo Barnechea. 
			  ...
			  <div class="collapse-content"> 
			    <div class="mockup-window border bg-base-300">
			  	  <div class="flex justify-center px-4 py-16 bg-base-200">
			  	  	  	<ul class="list-outside list-disc">
			  	  	  	    <li class="text-justify">Desarrollo versión de prueba para sistema de Abastecimiento, acreditación de solicitudes.  </li>
			  	  	  	    <ul class="menu menu-horizontal text-5xl rounded-box">
			  	  	  	      <li>
			  	  	  	        <a class="devicon-php-plain">
			  	  	  	        </a>
